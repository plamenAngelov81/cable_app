...
class CableCreateForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'cable_name': forms.TextInput(attrs={'placeholder': 'Enter Cable Name'}),
            'cap_number': forms.TextInput(attrs={'placeholder': 'Enter Cap Number'}),
            'clutch_number': forms.TextInput(attrs={'placeholder': 'Enter Clutch Number'}),
